...
const meta: Meta<StepsButtonComponent> = {
  title: 'UI Components/StepsButtonComponent',
  component: StepsButtonComponent,
  decorators: [
    moduleMetadata({
      imports: [],
    }),
  ...
  render: (args: StepsButtonComponent) => ({
    props: {
      ...args,
    },
  }),
...
export default meta;
type Story = StoryObj<StepsButtonComponent>;
